...
/**Represents fields from NGQ/ICM Scheduled device check profile */
public enum ScheduledDeviceCheckAttribute implements ProfileAttribute {
	...
	public Class<? extends AppProfile> getSubprofile() {
		return AppProfileType.SCHEDULED_DEVICE_CHECK.getProfileClass();
	}
}
