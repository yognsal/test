...
/**Represents fields from NGQ/ICM Parameter synch profile */
public enum ParameterSynchAttribute implements ProfileAttribute {
	...
	public Class<? extends AppProfile> getSubprofile() {
		return AppProfileType.PARAMETER_SYNC.getProfileClass();
	}
}
