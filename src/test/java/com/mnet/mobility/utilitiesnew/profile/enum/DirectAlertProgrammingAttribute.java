...
/**Represents fields from NGQ/ICM Remote Programming profile */
public enum DirectAlertProgrammingAttribute implements ProfileAttribute {
	...
	public Class<? extends AppProfile> getSubprofile() {
		return AppProfileType.DIRECT_ALERT_PROGRAMMING.getProfileClass();
	}
}
